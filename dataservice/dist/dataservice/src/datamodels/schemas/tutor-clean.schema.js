...
// Static methods
tutorSchema.statics.findByStatus = function (status) {
    return this.find({ 'status.current': status, isActive: true });
};
tutorSchema.statics.findByLocation = function (coordinates, maxDistance = 10000) {
    return this.find({
...
tutorSchema.methods.updateRating = function (averageRating, totalReviews, distribution) {
