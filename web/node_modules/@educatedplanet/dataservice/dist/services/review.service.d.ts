import { IReviewDocument } from '@educatedplanet/datamodels';
...
export declare class ReviewService {
     ...
     * Create a new review
     */
    createReview(reviewData: CreateReviewInput): Promise<IReviewDocument>;
    /**
     * Find review by ID
     */
    findReviewById(id: string): Promise<IReviewDocument | null>;
    /**
     ...
     */
    findReviewsByUserId(userId: string): Promise<IReviewDocument[]>;
    /**
     * Get pending reviews (admin function)
     */
    getPendingReviews(page?: number, limit?: number): Promise<IReviewDocument[]>;
    /**
     ...
     * Update review by ID
     */
    updateReview(id: string, updateData: UpdateReviewInput): Promise<IReviewDocument | null>;
    /**
     * Approve review (admin function)
     */
    approveReview(id: string, moderatedBy?: string): Promise<IReviewDocument | null>;
    /**
     * Reject review (admin function)
     */
    rejectReview(id: string, reason: string, moderatedBy: string): Promise<IReviewDocument | null>;
    /**
