...
class TutorService {
    ...
    async createTutor(tutorData) {
        ...
        const tutor = await datamodels_1.TutorQueries.create({
            ...tutorData,
    ...
    async findTutorById(id) {
        return await datamodels_1.TutorQueries.findById(id);
    }
    /**
    ...
    async getApprovedTutors(page = 1, limit = 20) {
        return await datamodels_1.TutorQueries.findApproved();
    }
    /**
     * Get featured tutors
     */
    async getFeaturedTutors(limit = 10) {
        return await datamodels_1.TutorQueries.findFeatured();
    }
    /**
     * Find tutors by subject
     */
    async findTutorsBySubject(subject, limit = 20) {
        return await datamodels_1.TutorQueries.findBySubjects([subject]);
    }
    /**
     * Find tutors by location
     */
    async findTutorsByLocation(city, areas) {
        return await datamodels_1.TutorQueries.findByLocation(city, areas);
    }
    /**
     * Find tutors by areas
     */
    async findTutorsByAreas(areas) {
        return await datamodels_1.TutorQueries.findByAreas(areas);
    }
    /**
     * Get top-rated tutors
     */
    async getTopRatedTutors(limit = 10) {
        return await datamodels_1.TutorQueries.getTopRated(limit);
    }
    /**
     * Get recently added tutors
     */
    async getRecentTutors(limit = 10) {
        return await datamodels_1.TutorQueries.getRecent(limit);
    }
    /**
     * Update tutor by ID
     */
    async updateTutor(id, updateData) {
        ...
        return await datamodels_1.TutorQueries.updateById(id, updateData);
    }
    /**
     * Approve tutor (admin function)
     */
    async approveTutor(id, approvedBy) {
        return await datamodels_1.TutorQueries.approveTutor(id, approvedBy);
    }
    /**
     * Reject tutor (admin function)
     */
    async rejectTutor(id, rejectionReason) {
        return await datamodels_1.TutorQueries.rejectTutor(id, rejectionReason);
    }
    /**
     * Get pending tutor applications (admin function)
     */
    async getPendingApplications(page = 1, limit = 20) {
        return await datamodels_1.TutorQueries.findPending();
    }
    /**
